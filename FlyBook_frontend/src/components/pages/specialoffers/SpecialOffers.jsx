        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <ul className={styles.detailsList}>
              <li><strong>Price:</strong> {selectedOffer.details.price}</li>
              <li><strong>Duration:</strong> {selectedOffer.details.duration}</li>
              <li><strong>Hotel:</strong> {selectedOffer.details.hotel}</li>
              <li><strong>Transport:</strong> {selectedOffer.details.transport}</li>
            </ul>
            <button
